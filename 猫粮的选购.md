...
```html
https://peekaboo.top/youmaoapp/paymentOrder
```
##  入参
### Post参数：
Object 类型，属性如下：
...
| :--- | :--- | :--- | :--- | :--- |
| **app_key** | String | 是 | 开发者唯一凭证，默认：youmaopeikepet | v1.0 |
| **order_id** | Sting | 是 | 唯一订单号 | v1.0 |
| **order_data** | Sting | 是 | 标准json类型，里面是业务参数按照参数 | v1.0 |
| type | Sting | 是 | "try_eat";"solid_food";"wet_food" | v1.0 |
| user_name | Sting | 是 | 收货人 |  |
| user_iphone | Sting | 是 | 收货电话 |  |
| user_adress | Sting | 是 | 收货地址 |  |
| o_price | Sting | 是 | 实收订单价格 |  |
| **timestamp** | String | 是 | 时间戳， 1561700872可转"%Y-%m-%d %H:%M:%S"
 | v1.0 |
...
{
  "app_key": "youmaopeikepet",
  "order_id":"18842615537" ,
  "order_data": {
                "type": "try_eat",
       			"user_name": "小公主",
         		"user_iphone": "18842615537",
        		"user_adress":"上海市闵行区马桥镇xxxxx",
                "o_price": "20.0"
    },
  "timestamp": "1561700872"
}
